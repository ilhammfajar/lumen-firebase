...
class FirebaseController extends Controller
{
    ...
    {
        $factory = (new Factory)
        ->withServiceAccount(__DIR__.'/crudlumen-firebase-adminsdk-nw674-79d564b135.json')
        ->withDatabaseUri('https://crudlumen-default-rtdb.firebaseio.com/');
